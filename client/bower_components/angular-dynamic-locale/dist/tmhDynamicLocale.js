...
.provider('tmhDynamicLocale', ['tmhDynamicLocale.STORAGE_KEY', function(STORAGE_KEY) {
  ...
  //https://cdnjs.cloudflare.com/ajax/libs/angular-i18n/1.5.8/angular-locale_es.js

  var defaultLocale,
    localeLocationPattern = 'https://cdnjs.cloudflare.com/ajax/libs/angular-i18n/1.5.8/angular-locale_{{locale}}.js',
    nodeToAppend,
